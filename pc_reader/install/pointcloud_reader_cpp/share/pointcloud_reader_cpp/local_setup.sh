...
: ${AMENT_CURRENT_PREFIX:="/HOST_HOME/Projects/sensmore/pc_reader/install/pointcloud_reader_cpp"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/pointcloud_reader_cpp/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/pointcloud_reader_cpp/environment/path.sh"
